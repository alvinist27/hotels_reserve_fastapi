...
from src.schemas.rooms import RoomAddRequestSchema, RoomAddSchema, RoomPatchRequestSchema, RoomPatchSchema, RoomSchema
...
class RoomService(BaseService):
    ...
    async def get_room_with_check(self, room_id: int) -> RoomSchema:
        try:
